...
|-------------------|------------------------|--------------------|
| day_of_the_year() | inputDate: struct date | Number of day: int |
...
| Function     | Parameters                   | Return value |
|--------------|------------------------------|--------------|
| input_date() | pointer: pointer struct date | none         |
...
| Function      | Parameters              | Return value                             |
|---------------|-------------------------|------------------------------------------|
| exists_date() | inputDate: struct Date  | 1 if date is valid, 0 if date is invalid |
